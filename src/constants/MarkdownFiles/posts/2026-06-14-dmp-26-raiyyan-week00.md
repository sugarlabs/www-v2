...
---
## Project Overview
Speak-AI is Sugar Labs' upgraded version of the classic 'Speak' activity. Instead of the old espeak engine that sounds like a robot, it uses **Kokoro**, an 82-million-parameter neural TTS model that produces natural-sounding speech. This is especially useful for children learning to read and pronounce words in their native language.
