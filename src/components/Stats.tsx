...
const Stats = () => {
  return (
    <section className="max-w-7xl mx-auto py-10 sm:py-16 md:py-20 px-4 sm:px-6 bg-white dark:bg-gray-900">
      ...
      <motion.div
        className="text-center mt-10 sm:mt-12 md:mt-16 pt-8 sm:pt-12 md:pt-16"
        ...
        <div className="relative mb-12 sm:mb-16 md:mb-24">
          ...
          >
            ...
            >
              ...
              lives changed through education and technology. Sugar Labs
              continues to grow and impact communities worldwide.
            </motion.p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 md:gap-4 max-w-6xl mx-auto px-2">
          {statisticsData.map((stat, index) => {
            return (
              ...
              >
                <span
                  className={`font-bold font-Caveat text-transparent bg-clip-text bg-gradient-to-r ${stat.gradient} text-2xl sm:text-xl md:text-4xl`}
                >
                  {stat.value}
                </span>

                <span
                  className={`font-AnonymousPro text-gray-700 dark:text-gray-300 text-2xs sm:text-xs md:text-sm text-center mt-0.5 sm:mt-1 whitespace-normal px-1 lg:group-hover:block`}
                >
                  {stat.title}
                </span>
              </motion.div>
