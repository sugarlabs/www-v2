...
export const ActivityCard: React.FC<ActivityCardProps> = ({
  ...
  <div className="bg-white rounded-xl sm:rounded-3xl p-4 sm:p-6 md:p-8 flex flex-col items-center text-center shadow-lg transition-transform hover:scale-105">
    ...
    <a href={href} className="w-full">
      <button className="w-full flex-1/3 py-2 sm:py-3 px-4 sm:px-6 border-2 border-gray-900 rounded-full text-sm sm:text-base md:text-lg font-semibold hover:bg-gray-900 hover:text-white transition-colors">
        {buttonText}
      </button>
    </a>
  </div>
