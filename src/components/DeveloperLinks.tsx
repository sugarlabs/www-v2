        ...
        {developerLinks.map((link, index) => (
          ...
          >
            ...
            <div className="relative flex items-center gap-4 z-10 flex-1">
              ...
              <span className="text-base md:text-lg font-medium text-gray-800 group-hover:text-sky-700 transition-colors">
                {link.name}
              </span>
            </div>

            {/* Arrow with enhanced animation */}
            <div className="relative z-10 flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 group-hover:bg-sky-200 transition-colors ml-4 flex-shrink-0">
              <span className="text-gray-600 group-hover:text-sky-700 transform group-hover:translate-x-1 transition-all">
                →
              </span>
            </div>
          </motion.a>
