...
const Footer = () => {
  return (
    <>
      <footer className="bg-gray-50 text-gray-700 dark:bg-gray-900 dark:text-gray-300 py-10 sm:py-16 px-4 sm:px-6 relative">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 sm:gap-10 mb-8 sm:mb-12">
            ...
            <div className="sm:col-span-2 lg:col-span-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2.5 sm:py-3 bg-gray-200/50 dark:bg-gray-800/50 hover:bg-gray-300 dark:hover:bg-gray-700
              ...
              {/* Organization Info */}
              <div className="p-4 sm:p-6 bg-gray-200/30 dark:bg-gray-800/30 rounded-lg backdrop-blur-sm">
          ...
          {/* Copyright */}
          <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 pt-4 sm:pt-6 border-t border-gray-300 dark:border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
            ...
            <p className="text-center sm:text-right">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors duration-300 underline decoration-dotted"
              >
